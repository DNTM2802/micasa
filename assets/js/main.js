...
(function($) {
  ...
  $(window).on('load', function() {
    ...
    $('.full-property-old').hide();
    $('.full-property-new').show();
  });
  ...
  $('#btn_antes').on('click', function() {
    $('.full-property-new').hide();
    $('.full-property-old').show();
  })
  $('#btn_depois').on('click', function() {
    $('.full-property-old').hide();
    $('.full-property-new').show();
  })
  ...
  $(window).bind('scroll', function() {
    ...
    if ($(window).scrollTop() > pixels) {
      ...
      $('.logo-img').addClass('logo-reduce');
      $('.logo-img').removeClass('logo-trans');
    } else {
      $('.navbar-default').addClass('navbar-trans');
      $('.navbar-default').removeClass('navbar-reduce');
      $('.logo-img').addClass('logo-trans');
      $('.logo-img').removeClass('logo-reduce');
    }
  ...
  /*--/ Property owl owl /--*/
  $('#property-single-carousel-new').owlCarousel({
    loop: true,
    margin: 0,
    nav: true,
    navText: ['<i class="ion-ios-arrow-back" aria-hidden="true"></i>', '<i class="ion-ios-arrow-forward" aria-hidden="true"></i>'],
  ...
  $('#property-single-carousel-old').owlCarousel({
    loop: true,
    margin: 0,
    nav: true,
    navText: ['<i class="ion-ios-arrow-back" aria-hidden="true"></i>', '<i class="ion-ios-arrow-forward" aria-hidden="true"></i>'],
